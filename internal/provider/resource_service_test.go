...
func svcChecks(nameSeed string) []resource.TestCheckFunc {
	return []resource.TestCheckFunc{
		...
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_updated_on", regexp.MustCompile(`\d+`)),
		...
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_created_by", regexp.MustCompile("svc_skysql_api")),
		...
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_updated_by", regexp.MustCompile(".+")),
		resource.TestMatchResourceAttr("skysql_service.wat", "bulkdata_port_2", regexp.MustCompile("")),
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_created_on", regexp.MustCompile(".+")),
		...
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_id", regexp.MustCompile(".+")),
		...
		resource.TestMatchResourceAttr("skysql_service.wat", "sys_mod_count", regexp.MustCompile(".+")),
