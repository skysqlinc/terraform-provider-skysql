		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.skysql_database.wat", "enable_pam_authentication", regexp.MustCompile("false")),
					...
					resource.TestMatchResourceAttr("data.skysql_database.wat", "id", regexp.MustCompile("db00008965")),
					...
					resource.TestMatchResourceAttr("data.skysql_database.wat", "sys_updated_by", regexp.MustCompile("dev.midserver")),
					...
					resource.TestMatchResourceAttr("data.skysql_database.wat", "sys_mod_count", regexp.MustCompile("8")),
