		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_updated_on", regexp.MustCompile(`\d+`)),
					...
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_created_by", regexp.MustCompile("don.mayo@mariadb.com")),
					...
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_updated_by", regexp.MustCompile(".+")),
					resource.TestMatchResourceAttr("data.skysql_service.wat", "bulkdata_port_2", regexp.MustCompile("")),
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_created_on", regexp.MustCompile("2021-06-17 13:18:35")),
					...
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_id", regexp.MustCompile("13107475db38bc50687f0793e2961930")),
					...
					resource.TestMatchResourceAttr("data.skysql_service.wat", "sys_mod_count", regexp.MustCompile(`\d+`)),
